...
const HomePage = ({ data }) => {
  return (
    <Layout>
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-blitz-white">
      ...
      {/* Experience Section */}
      <section id="experience" className="py-20 bg-blitz-sand-light">
        <div className="max-width-container section-padding">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-blitz-primary">
            Experience
          </h2>
            ...
            <div className="card p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-blitz-coral mt-1 mr-3 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-blitz-white">
        <div className="max-width-container section-padding">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-blitz-primary">
            Let's Connect
          </h2>
