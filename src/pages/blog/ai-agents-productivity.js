      ...
      <article className="py-20 bg-blitz-white min-h-screen">
        <div className="max-width-container section-padding">
          ...
          <div className="prose-blitz">
            ...
            <p>
              AI coding agents have evolved far beyond autocomplete. Today's
              tools can autonomously implement features, debug complex issues,
              and handle entire workflows while you focus on higher-level work.
              But here's the thing: having access to powerful tools doesn't
              automatically make you productive. The difference between "AI
              helps sometimes" and "AI makes me 3x more effective" comes down to
            ...
            <p>
              ...
              understanding the tool landscape, setting up efficient workflows,
              and building team-wide capabilities that compound over time.
            </p>

            <h2>Understanding the AI Coding Agent Landscape</h2>

            <p>
              Modern AI coding agents generally fall into two categories, each
              suited to different types of work:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              <div className="bg-blitz-accent/5 border border-blitz-accent/20 p-6 rounded-lg">
                ...
                <p className="text-sm text-blitz-charcoal/80 mb-4">
                  Work independently on well-defined tasks. You assign work,
                  they execute, you review later.
                </p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    <span className="text-blitz-accent mr-2">•</span>
                    <span>
                      <strong>Devin:</strong> Full-stack autonomous agent for
                      complex features
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <span className="text-blitz-accent mr-2">•</span>
                    <span>
                      <strong>Linear + Cursor:</strong> Assign issues directly
                      to Cursor's agent via @cursor
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blitz-accent mr-2">•</span>
              ...
              <div className="bg-blitz-soft/5 border border-blitz-soft/20 p-6 rounded-lg">
                ...
                <p className="text-sm text-blitz-charcoal/80 mb-4">
                  Work alongside you in real-time. Best for exploration,
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Claude Code:</strong> Terminal-based pair
                      programming
                    </span>
                  </li>
                  <li className="flex items-start">
            ...
            <p>
              Understanding which type of agent to use for which task is
              crucial. If you haven't already, check out my{' '}
              <Link
            ...
            <p>
              Modern AI coding tools offer autonomous agent capabilities that
              can work on tasks independently while you focus on other things.
              The workflow is seamless: create a task in your project management
              tool, connect it to your AI coding assistant (many tools offer
              integrations with Linear, GitHub Issues, or Jira), assign it to an
              agent, and let it work autonomously.
            </p>

            <p>
              For example, we use cloud-based AI agents that can handle
              delegated tasks in the background. The key is having a clear
              handoff process. The agent needs to know exactly what to do, where
              to find relevant code, and what success looks like.
            </p>

            <div className="my-8 max-w-3xl mx-auto">
              <img
                src={
                  require('../../assets/images/cursor-cloud-agent.avif').default
                }
            ...
            <p>
              ...
              <strong>Linear + Cursor integration</strong> is a great example:
              you can mention <code>@cursor</code> in any Linear issue comment
              or select Cursor from the assignee menu, and the cloud agent
              automatically picks up the task, works on it, and creates a PR
              when done, all while keeping Linear updated with progress.
            </p>

            <p>
              In our team, we've found a pretty convenient workflow (not an
              endorsement, just what works for us): when non-engineers flag an
              issue or bug in Slack, they can use{' '}
              <code>@linear create a ticket based on this context</code>
              to instantly create a properly formatted ticket with all the
              relevant discussion. Then we just assign it to{' '}
              <code>@cursor</code> and let it handle the investigation and fix.
              It's seamless because everything stays in the tools we're already
              using, with no context switching required.
            </p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    voice-to-text tools to quickly capture tasks with full
                    context.
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Task Enrichment:</strong> Add code references,
                    examples, and success criteria before assigning to an agent.
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 text-xl">3.</span>
                  <div>
                    <strong>Agent Assignment:</strong> Match the task complexity
                    to the right agent capability.
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 text-xl">4.</span>
                  <div>
                    <strong>Batch Review:</strong> Schedule time to review
                    completed tasks together rather than context-switching
                    throughout the day.
                  </div>
                </li>
              </ul>
            ...
            <p>
              One thing I see people struggle with is giving AI the right
              context about their codebase. You can't just say "update the
              context" and expect your AI to know what you mean. Is it React
              Context? Some other state management? A feature flag?
            </p>

            <p>
              Here's what works: create a documentation file (like{' '}
              <code>agents.md</code> or <code>.ai-context.md</code>) in your
              repo that explains your codebase patterns. Not the whole
              architecture diagram. Just the stuff that's confusing or
              non-obvious:
            </p>
...
- Mock external APIs with MSW handlers in tests/mocks/`}
            ...
            <p>
              ...
              preferences," it knows exactly what you mean. No more
              back-and-forth clarifying which "context" you're talking about.
              This single file has probably saved our team hours of
              miscommunication.
            </p>
            ...
            <p>
              ...
              patterns. Think about it: when you're hunting for a bug, you
              probably follow the same process every time. Check recent git
              commits, look at related files, trace the data flow, check the
              tests, etc.
            </p>

            <p>
              Instead of manually guiding your AI through this process every
              time, you can create a documented workflow or custom instruction
              set. Now when you say "help me debug this checkout issue," your AI
              assistant automatically knows to:
            </p>
            ...
            <p>
              The agent works autonomously through your systematic debugging
              process and comes back with either "found the bug" or "didn't find
              the bug, here's what I checked." Either way, you saved 30 minutes
              of manual investigation. Many AI coding tools support custom
              instructions, project-level prompts, or skill systems to encode
              these workflows. Check out my{' '}
              <Link
            ...
            <p>
              For tasks you do repeatedly, create specification templates that
...
- Application builds without warnings`}
            ...
            <p>
              One productivity hack that's been game-changing: use voice-to-text
              tools like Super Whisper or the built-in dictation on your OS to
              quickly capture task specifications. It's much faster to describe
              what you need verbally than to type it out, especially for
              detailed requirements.
            </p>

            <p>
              Speak your requirements, let the tool transcribe them, then
              quickly clean up the text before creating your task. This alone
              has probably doubled my delegation throughput.
            </p>

            <h2>Building Team Capabilities</h2>

            <p>
              Okay, so you've figured out how to be productive with AI. That's
              great for you. But if you're on a team, the real win is getting
              everyone else up to speed too. And that means documenting what
            ...
            <p>
              That <code>agents.md</code> file for context patterns? That's just
              the start. Turn it into a living document that captures everything
              your team learns about working with AI:
            </p>

            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Failure Patterns:</strong> "Don't ask AI to refactor
                auth logic, it always misses edge cases"
              </li>
              <li>
                <strong>Success Templates:</strong> Proven task specifications
                that work reliably
              </li>
              <li>
                <strong>Context Guidelines:</strong> How to reference your
                specific codebase patterns
              </li>
              <li>
                <strong>Agent Strengths:</strong> "Use Devin for full features,
                Claude Code for debugging, Cursor for quick edits"
              </li>
            </ul>

            <p>
              Keep this in Notion or your wiki. Make it searchable. Update it
              when you learn something new. This is how you go from "some people
              on the team use AI sometimes" to "everyone on the team is 3x more
              productive."
            </p>
...
└─ AI workflows become default
   └─ Onboarding includes AI patterns
      └─ Continuous improvement culture`}
            ...
            <p>
              When bringing new engineers onto a team with established AI
              workflows, include these in their onboarding:
            </p>
            ...
            <div className="bg-blitz-accent/5 border-l-4 border-blitz-accent p-6 my-8">
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Tool Setup:</strong> Which AI tools the team uses
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Pairing Session:</strong> Watch an experienced team
                    member use AI for a real task
                  </div>
                </li>
                <li className="flex items-start">
            ...
            <p>
              How do you know if your AI workflows are actually working? Here
              are some signals to watch:
            </p>
            ...
            <div className="bg-gradient-to-r from-blitz-accent/10 to-blitz-soft/10 border border-blitz-accent/20 p-8 rounded-lg my-8">
              <ol className="space-y-4 text-lg">
                <li>
                  <strong>1. Understand the Tool Landscape:</strong> Match
                  autonomous agents to well-defined tasks, collaborative agents
                  to exploration and complex problems.
                </li>
                <li>
                  <strong>2. Invest in Workflow Setup:</strong> Project
                  management integrations and streamlined pipelines pay
                  dividends in reduced friction.
                </li>
                <li>
                  <strong>3. Create an agents.md File:</strong> Document
                  non-obvious patterns, gotchas, and conventions to give AI the
                  context it needs.
                </li>
                <li>
                  <strong>4. Codify Repeatable Workflows:</strong> Turn
                  debugging processes and common tasks into reusable templates
                  and custom instructions.
                </li>
                <li>
                  <strong>5. Build Team Knowledge:</strong> Document successes
                  and failures, share learnings, include AI workflows in
                  onboarding.
                </li>
                <li>
                  <strong>6. Measure and Iterate:</strong> Watch for positive
                  and negative signals, continuously improve your workflows
            ...
            <p>
              ...
              access to the best tools. They're the ones that build systems
              around those tools. Creating an agents.md file takes an hour.
              Setting up project management integrations takes an afternoon.
              Building a culture of sharing AI learnings takes consistent effort
              but pays off exponentially.
            </p>

            <p>
              Start small. Create your first agents.md file today. Write one
              task template for something you do often. Share what works with
              your team. These small investments compound into massive
              productivity gains over time.
            </p>

            <p>
              The goal isn't just to make yourself more productive. It's to make
              your entire team unstoppable.
            </p>
          </div>
